...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/customer/navbar.css') ?>">
...
<body>
    ...
    <script src="<?= base_url('assets/js/customer/navbar.js') ?>"></script>
    <script src="<?= base_url('assets/js/customer/footer.js') ?>"></script>
